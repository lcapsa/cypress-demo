...
describe("GROUPS - EVENTS - MEMBERS - UPDATE", function () {
  before(function () {
  ...
  describe("Member is successfully updated @SMOKE", function () {
    it("Group admin successfully updates a member from an event", function () {
      cy.log(
        "Precondition: Admin " +
          this.professorUaId +
    ...
    it("Group coordinator successfully updates a member from an event", function () {
      cy.log(
        "Precondition: Admin " +
          this.professorUaId +
          " adds user " +
  ...
  describe("Event instance member is not updated", function () {
    it("Group member can not update instance member", function () {
      cy.log(
